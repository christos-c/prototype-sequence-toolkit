...
/**
 * <p> This utility class allows for initialization of all Java(tm) classes at startup to avoid initialization delays at
 * an innapropriate time.</p> For example:[code] public static main(String[] args) { LogContext.enter(LogContext.NULL);
 * // Temporarely disables logging errors and warnings.
 *  try { ClassInitializer.initializeAll();
 * // Initializes bootstrap, extensions and classpath classes. }
 * finally { LogContext.exit(LogContext.NULL); } ... }[/code]</p>
 *
...
public class ClassInitializer {
    static class StandardLog {
        ...
        public static void fine(Object o) {
            if (verbose >= 1) System.err.println(o);
        }

        public static void finer(Object o) {
            if (verbose >= 2) System.err.println(o);
        }
    }
    ...
    /**
     * Initializes runtime classes (bootstrap classes in <code> System.getProperty("sun.boot.class.path"))</code>  and
     * the extension <code>.jar</code> in <code>lib/ext</code> directory).
     */
     ...
     *
     * @param dirName the name of the directory containing the classes to initialize.
     */
