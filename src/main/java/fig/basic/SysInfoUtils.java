...
public class SysInfoUtils {
    ...
    public static int getNumCPUs() {
        ...
        try {
            ...
            return numCPUs = Integer
                    .parseInt(StrUtils.split(Utils.systemGetStringOutput("sysctl hw.ncpu").trim(), " ")[1]);
        } catch (Exception e) {
        }
    ...
    public static int getCPUSpeed() {
        ...
        try {
            ...
            return cpuSpeed = Integer.parseInt(
                    StrUtils.split(Utils.systemGetStringOutput("sysctl hw.cpufrequency").trim(), " ")[1]) / 1000000;
        } catch (Exception e) {
        }
