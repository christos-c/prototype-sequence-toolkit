...
public class Filters {
     ...
     */
    public static <T> Filter notFilter(Filter<T> filter) {
     ...
     */
    public static <T> Filter switchedFilter(Filter<T> filter, boolean negated) {
    ...
    /**
     * Applies the given filter to each of the given elems, and returns the list of elems that were accepted. The
     * runtime type of the returned array is the same as the passed in array.
     */
