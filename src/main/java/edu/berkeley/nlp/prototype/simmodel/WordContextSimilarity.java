...
public class WordContextSimilarity extends PrototypeSimilarityModel implements Serializable, Runnable {
    ...
    public double getSimilarity(String word1, String word2) {
        ...
        switch (dataRepn) {
            case DENSE:
                return getSimilarityDense(index1, index2);
            case SPARSE:
                return getSimilaritySparse(index1, index2);
        }
        throw new RuntimeException();
    }
    ...
    private void setup(Iterable<List<String>> data) {
        ...
        List<String> words = wordFile != null ? IOUtils.readLinesHard(wordFile) : topWords
                .subList(0, Math.min(topWords.size(), numWords));
        ...
        List<String> contextWords = contextWordFile != null ? IOUtils.readLinesHard(contextWordFile) : topWords
                .subList(0, Math.min(topWords.size(), numContextWords));
