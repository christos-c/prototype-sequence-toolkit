...
/**
 * Similar to PTBLexer. However, instead of reading from a Reader this class is given a line and returns a list of
 * tokenized Strings.
 *
 * @author petrov
 */
public class PTBLineLexer extends PTBLexer {
    ...
    public List<String> tokenizeLine(String line) throws IOException {
        ...
        while (yy_markedPos < yy_endRead) tokenized.add(next());
        return tokenized;
    }
