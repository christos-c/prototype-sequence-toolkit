...
/**
 * This class is a scanner generated by <a href="http://www.jflex.de/">JFlex</a> 1.4_5 on 11/30/03 2:25 PM from the
 * specification file <tt>PTBLexer.flex</tt>
 */
public class PTBLexer {
     ...
     */
    private static final String yycmap_packed = "\1\130\10\0\1\45\1\46\1\0\1\76\1\131\22\0\1\115\1\3" +
    ...
    private static final String YY_ACTION_packed0 = "\1\1\1\2\3\3\23\4\2\3\2\4\1\5\1\6" +
    ...
    private static final String yy_rowMap_packed0 = "\0\0\0\132\0\264\0\132\0\u010e\0\u0168\0\u01c2\0\u021c" +
    ...
    private static final String yytrans_packed0 = "\1\2\1\3\3\4\1\5\1\6\1\7\1\10\1\11" +
    ...
    private static final String YY_ERROR_MSG[] = {"Unkown internal scanner error", "Error: could not match input",
    ...
    private static final String YY_ATTRIBUTE_packed0 = "\1\1\1\11\1\1\1\11\1\1\23\3\2\1\2\3" +
    ...
    public void yypushback(int number) {
        if (number > yylength()) yy_ScanError(YY_PUSHBACK_2BIG);
        ...
        while (true) {
            ...
            yy_forAction:
            {
                while (true) {
                    ...
                    if ((yy_attributes & 2) == 2) yy_pushbackPos_l = yy_currentPos_l;
            ...
            yy_markedPos = yy_markedPos_l;
            if (yy_was_pushback) yy_markedPos = yy_pushbackPos_l;

            switch (yy_action < 0 ? yy_action : YY_ACTION[yy_action]) {
                case 10: { return closedblquote; }
                case 18:
                    break;
                case 9: { return closeparen; }
                case 19:
                    break;
                case 4: { return yytext(); }//String word = Americanize.americanize(yytext());
                //return word; }
                case 20:
                    break;
                case 13: { return opendblquote; }
                case 21:
                    break;
                case 14: { return (delimit(yytext(), '/')); }
                case 22:
                    break;
                case 5: { /* ignore */ }
                case 23:
                ...
                case 24:
                    break;
                case 11: { return openbrace; }
                case 25:
                    break;
                case 3: { return yytext(); }
                case 26:
                    break;
                case 7: {
                ...
                case 27:
                    break;
                case 8: { return openparen; }
                case 28:
                    break;
                case 2: { /*System.err.println(yytext());*/ }
                case 29:
                    break;
                case 15: { return ptbmdash; }
                case 30:
                    break;
                case 1: { return (delimit(yytext(), '*')); }
                case 31:
                    break;
                case 6: { return (cr); }
                case 32:
                    break;
                case 12: { return closebrace; }
                case 33:
                    break;
                case 16: {
                    yypushback(1);
    ...
    public static void main(String argv[]) {
        if (argv.length == 0) {
            System.out.println("Usage : java PTBLexer <inputfile>");
        } else {
