...
public class PennTreebankLanguagePack extends AbstractTreebankLanguagePack implements Serializable {
    ...
    /**
     * The first 3 are used by the Penn Treebank; # is used by the BLLIP corpus, and ^ and ~ are used by Klein's
     * lexparser. Teg added the last one _ (let me know if it hurts).
     */
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < strs.length; i++) {
            String str = strs[i];
            System.out.println("String: " + str + " basic: " + tlp.basicCategory(str) + " basicAndFunc: " + tlp
                    .categoryAndFunction(str));
        }
    }
